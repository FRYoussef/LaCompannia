...
public class GUITransporteImpOtro extends GUITransporte {
	
	private JFrame principal;
	private JButton nuevo;
	private JButton nue;
	
	public GUITransporteImpOtro()	{
		...
		(
			new WindowAdapter()
			{
				...
				{
					JOptionPane.showMessageDialog(GUITransporteImpOtro.this.principal, "Saliendo Subsistema Transporte", "Subsistema Transporte", JOptionPane.INFORMATION_MESSAGE);
					GUITransporteImpOtro.this.principal.dispose();
					deleteInstance();
				}
			}
		);

...
public class TransferPedido_GC {
	...
	private List<TransferProducto_GC> productos;
	private int _cantidad;
	
	public TransferPedido_GC()	{
	...
	public List<TransferProducto_GC> getProductos() {
		return productos;
	}

	public void setProductos(List<TransferProducto_GC> productos) {
